...
```sql CREATE TABLE calendario_coleta (
    id SERIAL PRIMARY KEY,
    bairro VARCHAR(150) NOT NULL,
    tipo_coleta VARCHAR(100) NOT NULL,
...
```sql CREATE TABLE agendamentocoleta (
    id SERIAL PRIMARY KEY,
...
```sql INSERT INTO usuario (nome, email, senha, bairro)
VALUES
...
```sql INSERT INTO cooperativa (nome, telefone, tipos_coletados)
VALUES 
...
```sql INSERT INTO pontodeentrega (nome, endereco, tipos_aceitos, latitude, longitude)
VALUES
...
```sql INSERT INTO calendario_coleta (bairro, tipo_coleta, dias_semana, horario)
VALUES
...
```sql INSERT INTO agendamentocoleta (usuario_id, cooperativa_id, descricao_item, data_agendamento, status)
VALUES
